...
DOUBLE_RELOCATE_BOUND = [-0.1, 0.8, -2, 2, DESK2ROBOT_Z_AXIS + 0.001, 0.6]
#DOUBLE_RELOCATE_BOUND = [-2., 2.8, -4, 4,-4, 4]
...
DOUBLE_CAM2BASE=Pose(p=np.array([0.7, 0., 0.7]),q=np.array([0.35355339,-0.61237244,-0.61237244, 0.35355339]))
...
l_ROBOT2BASE = Pose(p=np.array([0, 0.47, -DESK2ROBOT_Z_AXIS]))  # Pose(p=np.array([-0.55, 0., -DESK2ROBOT_Z_AXIS]))
r_ROBOT2BASE = Pose(p=np.array([0, -0.47, -DESK2ROBOT_Z_AXIS]))  # Pose(p=np.array([-0.55, 0., -DESK2ROBOT_Z_AXIS]))
